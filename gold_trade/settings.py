...
SECRET_KEY = 'django-insecure-b8fs*4h2f5fr-@_zvjh+k0(hs(zh#_rmc=d#&-vkhk0!i+xa7f'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'hifas86@gmail.com'  # your sender address
EMAIL_HOST_PASSWORD = 'pouv abzh xnkp whzi'  # use an app password
...
# ✅ Database (use SQLite locally / Postgres on Vercel)
if 'DATABASE_URL' in os.environ:
    DATABASES = {
        'default': dj_database_url.config(default=os.environ['DATABASE_URL'])
    }

# ✅ Secret Key (don’t hardcode for deployment)
